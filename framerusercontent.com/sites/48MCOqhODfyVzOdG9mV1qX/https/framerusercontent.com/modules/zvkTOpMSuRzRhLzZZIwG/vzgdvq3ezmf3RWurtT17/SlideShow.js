...
import {
    usePageVisibility
} from "../../../../../../../../framerusercontent.com/modules/V9ryrjN5Am9WM1dJeyyJ/GzHgU466IQmt8g4qOKj8/UsePageVisibility.js";
...
function awaitRefCallback(element, controller) {
    ...
    Object.defineProperty(element, "current", {
        ...
        set(node) {
            current = node;
            if (node === null) { // React calls with null when the element is unmounted
...
export default function Slideshow(props) {
     ...
     */
    const {
        slots = [], startFrom, direction, effectsOptions, autoPlayControl, dragControl, alignment, gap, padding, paddingPerSide, paddingTop, paddingRight, paddingBottom, paddingLeft, itemAmount, fadeOptions, intervalControl, transitionControl, arrowOptions, borderRadius, progressOptions, style
    } = props;
    const {
        effectsOpacity,
        effectsScale,
    ...
    const childrenRef = useMemo(() => {
        return [{
            ...
            current: null
        }]; // when the slots change, generate new array
    }, [filteredSlots]);
    ...
    } /* Check for browser window visibility */ /* Otherwise, it will re-play all the item increments */
    ...
    const canvasPosition = isHorizontal ? -startFrom * (size ? .itemWidth + gap) : -startFrom * (size ? .itemHeight + gap); /* Calculate the new value to animate to */
    ...
    const handleDragEnd = (event, {
        ...
        if (velocityXorY > velocityThreshold) {
            ...
            setDelta(itemDeltaFromOne, true);
        } else { /* For dragging over half of the current item with 0 velocity */
            if (isHalfOfNext) {
    ...
    return /*#__PURE__*/ _jsxs("section", {
        ...
        onMouseDown: event => { // Preventdefault fixes the cursor switching to text on drag on safari
            ...
            children: [ /*#__PURE__*/ _jsxs(motion.div, {
                ...
                children: [ /*#__PURE__*/ _jsx(motion.button, {
                    ...
                    children: /*#__PURE__*/ _jsx("img", {
                        ...
                        width: arrowSize,
                        height: arrowSize,
                        src: leftArrow || "../../../../../../../../framerusercontent.com/images/6tTbkXggWgQCAJ4DO2QEdXXmgM.svg",
                        alt: "Back Arrow"
                    })
                    ...
                    children: /*#__PURE__*/ _jsx("img", {
                        ...
                        width: arrowSize,
                        height: arrowSize,
                        src: rightArrow || "../../../../../../../../framerusercontent.com/images/11KSGbIZoRSg4pjdnUoif6MKHI.svg",
                        alt: "Next Arrow"
                    })
                })]
...
const Slide = /*#__PURE__*/ memo( /*#__PURE__*/ forwardRef(function Component(props, ref) {
    const {
        slideKey,
        width,
        height,
    ...
    const visibility = isCanvas ? "visible" : useTransform(wrappedValue, [scrollRange[0] - size.viewportLength, mix(scrollRange[1], scrollRange[2], .5), scrollRange[3] + size.viewportLength], ["hidden", "visible", "hidden"]);
...
const Dot = /*#__PURE__*/ memo(function Dot({
    ...
    isInverted,
    ...props
}) { /* Check active item */ /* Go 0—1—2—3—4—5—0 */
    let isSelected = wrappedIndex === index; /* Go 0—5—4—3—2—1—0—5 instead when inverted */
    if (isInverted) {
