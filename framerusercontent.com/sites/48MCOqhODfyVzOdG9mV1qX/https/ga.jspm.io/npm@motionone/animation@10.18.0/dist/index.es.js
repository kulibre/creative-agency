...
class Animation {
    constructor(t, i = [0, 1], {
        ...
        this.tick = i => {
            ...
            l;
            let s = 0;
            s = this.pauseTime !== void 0 ? this.pauseTime : (i - this.startTime) * this.rate;
            this.t = s;
            s /= 1e3;
            s = Math.max(s - l, 0);
            this.playState === "finished" && this.pauseTime === void 0 && (s = this.totalDuration);
            ...
            r === 1 && n--;
            const o = n % 2;
            (p === "reverse" || p === "alternate" && o || p === "alternate-reverse" && !o) && (r = 1 - r);
            const h = s >= this.totalDuration ? 1 : Math.min(r, 1);
            const m = f(this.easing(h));
            t(m);
            const c = this.pauseTime === void 0 && (this.playState === "finished" || s >= this.totalDuration + u);
            if (c) {
                this.playState = "finished";
                (e = this.resolve) === null || e === void 0 ? void 0 : e.call(this, m)
            } else this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick))
        };
        d && this.play()
    }
    play() {
