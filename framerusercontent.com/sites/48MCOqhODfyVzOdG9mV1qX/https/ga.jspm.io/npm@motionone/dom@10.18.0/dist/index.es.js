import {
    getEasingFunction as e,
    Animation as t
} from "@motionone/animation";
import {
    invariant as n
} from "hey-listen";
import {
...
const buildTransformTemplate = e => e.sort(compareTransformOrder).reduce(transformListToString, "").trim();
const transformListToString = (e, t) => `${e} ${t}(var(${asTransformCssVar(t)}))`;
...
const convertEasing = (e, t) => a(e) ? R.linearEasing() ? `linear(${generateLinearEasingPoints(e,t)})` : c.easing : l(e) ? cubicBezierAsString(e) : e;
const cubicBezierAsString = ([e, t, n, o]) => `cubic-bezier(${e}, ${t}, ${n}, ${o})`;
...
function getUnitConverter(e, t) {
    ...
    if (f(s)) {
        const e = ((n = s.match(/(-?[\d.]+)([a-z%]*)/)) === null || n === void 0 ? void 0 : n[2]) || "";
        e && (o = t => t + e)
    }
    return o
}
...
function animateStyle(e, t, n, o = {}, i) {
    ...
    return () => {
        const readInitialValue = () => {
            var t, n;
            return (n = (t = I.get(e, W)) !== null && t !== void 0 ? t : T === null || T === void 0 ? void 0 : T.initialValue) !== null && n !== void 0 ? n : 0
        };
        ...
        isCssVar(W) && (R.cssRegisterProperty() ? registerCssVariable(W) : V = false);
        z && !R.linearEasing() && (a(w) || d(w) && w.some(a)) && (V = false);
        if (V) {
            T && (c = c.map((e => g(e) ? T.toDefaultUnit(e) : e)));
            c.length !== 1 || R.partialKeyframes() && !r || c.unshift(readInitialValue());
            const t = {
                delay: m.ms(p),
                duration: m.ms(f),
                endDelay: m.ms(v),
            ...
            l.finished || (l.finished = new Promise(((e, t) => {
                l.onfinish = e;
                l.oncancel = t
            })));
...
function resolveElements(e, t) {
    ...
    if (typeof e === "string")
        if (t) {
            (n = t[e]) !== null && n !== void 0 ? n : t[e] = document.querySelectorAll(e);
            e = t[e]
...
const withControls = (e, t, n = c.duration) => new Proxy({
...
const U = {
    get: (e, t) => {
        ...
        switch (t) {
            ...
            case "finished":
                e.finished || (e.finished = Promise.all(e.animations.map(selectFinished)).catch(h));
                return e.finished;
            case "stop":
                return () => {
            ...
            default:
                return typeof(n === null || n === void 0 ? void 0 : n[t]) === "undefined" ? void 0 : () => e.animations.forEach((e => e[t]()))
        }
    },
    set: (e, t, n) => {
        switch (t) {
...
function calcNextTime(e, t, n, o) {
    var i;
    return g(t) ? t : t.startsWith("-") || t.startsWith("+") ? Math.max(0, e + parseFloat(t)) : t === "<" ? n : (i = o.get(t)) !== null && i !== void 0 ? i : e
}
...
function timeline(e, n = {}) {
    ...
    return withControls(s, n, (o = i[0]) === null || o === void 0 ? void 0 : o[3].duration)
}

function createAnimationsFromTimeline(e, t = {}) {
    var {
        defaultOptions: o = {}
    } = t, i = S(t, ["defaultOptions"]);
    const s = [];
    const a = new Map;
    const l = {};
    const d = new Map;
    ...
    for (let t = 0; t < e.length; t++) {
        ...
        for (let e = 0; e < b; e++) {
            ...
            for (const t in r) {
                ...
                if (u(d)) {
                    n(t === "opacity" || a.length > 1, "spring must be provided 2 keyframes within timeline()");
    ...
    a.forEach(((e, t) => {
        for (const n in e) {
            ...
            s.push([t, n, l, Object.assign(Object.assign(Object.assign({}, o), {
                duration: h,
                easing: u,
                offset: f
            }), i)])
...
function createGeneratorEasing(e) {
    ...
    return (n = {}) => {
        ...
        const getGenerator = (t = 0, i = 100, s = 0, r = false) => {
            const a = `${t}-${i}-${s}-${r}`;
            o.has(a) || o.set(a, e(Object.assign({
                from: t,
                to: i,
                velocity: s
            }, n)));
        ...
        return {
            createAnimation: (e, t = true, n, o, s) => {
                ...
                if (t) {
                    ...
                    if (u > 1 && e[0] !== null) a = getAsNumber(e[0]);
                        ...
                        if (e) {
                            ...
                            const o = (t === null || t === void 0 ? void 0 : t.startTime) || n || 0;
                            const i = (t === null || t === void 0 ? void 0 : t.currentTime) || performance.now() - o;
                            const r = e(i).current;
                            a = r;
                ...
                if (canGenerate(a) && canGenerate(c)) {
                    const e = getGenerator(a, c, l, o === null || o === void 0 ? void 0 : o.includes("scale"));
...
function notifyTarget({
    ...
    var o;
    (o = _.get(e)) === null || o === void 0 ? void 0 : o.forEach((o => {
        o({
            target: e,
            contentSize: t,
            get size() {
...
function resizeElement(e, t) {
    ...
    return () => {
        n.forEach((e => {
            ...
            (n === null || n === void 0 ? void 0 : n.size) || (Z === null || Z === void 0 ? void 0 : Z.unobserve(e))
        }))
    }
}
const X = new Set;
...
function scrubAnimation(e, t) {
    ...
    e.forEachNative(((e, {
        ...
        if (e.updateDuration) {
            ...
            t || (i.easing = "linear");
            (o = (n = e.effect) === null || n === void 0 ? void 0 : n.updateTiming) === null || o === void 0 ? void 0 : o.call(n, i)
        }
    }));
    return () => {
...
const motionEvent = (e, t) => new CustomEvent(e, {
    detail: {
        target: t
    }
});
...
function createMotionState(e = {}, o) {
    ...
    const a = {};
    const c = {};
    for (const t of de) c[t] = typeof e[t] === "string" ? e[t] : o === null || o === void 0 ? void 0 : o.getContext()[t];
    ...
    function* animateUpdates() {
        ...
        for (const t of de) {
            ...
            if (i)
                for (const t in i)
                    if (t !== "transition") {
                        u[t] = i[t];
                        a[t] = getOptions((o = (n = i.transition) !== null && n !== void 0 ? n : e.transition) !== null && o !== void 0 ? o : {}, t)
                    }
        }
        ...
        Promise.all(f.map((e => e.finished))).then((() => {
    ...
    const updateGestureSubscriptions = () => {
        for (const t in ue) {
            ...
            const o = a[t];
            if (n && !o) a[t] = ue[t].subscribe(i, {
                enable: setGesture(t, true),
                disable: setGesture(t, false)
            }, e);
            else if (!n && o) {
                o();
                delete a[t]
...
export {
    ee as ScrollOffset, F as animate, animateStyle, createAnimate, createMotionState, createStyleString, createStyles, getAnimationData, getStyleName, q as glide, inView$1 as inView, ge as mountedStates, resize, scroll, G as spring, stagger, I as style, timeline, withControls
};
