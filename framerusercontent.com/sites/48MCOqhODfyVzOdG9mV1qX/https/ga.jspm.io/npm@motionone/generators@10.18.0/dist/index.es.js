...
const calcDampingRatio = (e = r.stiffness, t = r.damping, s = r.mass) => t / (2 * Math.sqrt(e * s));
...
const spring = ({
    ...
    if (l < 1) {
        ...
        m = t => o - Math.exp(-l * f * t) * ((l * f * d - c) / e * Math.sin(e * t) + d * Math.cos(e * t))
...
const glide = ({
    ...
    const isOutOfBounds = e => i !== void 0 && e < i || h !== void 0 && e > h;
    const nearestBoundary = e => i === void 0 ? h : h === void 0 || Math.abs(i - e) < Math.abs(h - e) ? i : h;
    let l = n * s;
    const g = e + l;
